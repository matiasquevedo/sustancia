...
CREATE TABLE `courts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `courts_company_id_foreign` (`company_id`),
  CONSTRAINT `courts_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `business` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2018_08_23_123233_add_table_business',1),(4,'2018_08_23_123418_add_table_courts',1),(5,'2018_08_23_124338_add_table_turns',2),(6,'2018_08_23_124514_add_table_reservations',2),(7,'2018_08_23_124637_add_table_bookings',2);
...
CREATE TABLE `turns` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `fecha` varchar() COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `turns_court_id_foreign` (`court_id`),
  CONSTRAINT `turns_court_id_foreign` FOREIGN KEY (`court_id`) REFERENCES `courts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (5,'Matias Quevedo','matiasquevedo.sabbath@gmail.com','$2y$10$BqXxfmzj5jXLxw1OUNMC2ulwjL3L6SuCTfmLyK5Jd4iigpJixsli2','admin',NULL,'2018-08-23 18:40:42','2018-08-23 18:40:42');
...
-- Dump completed on 2018-08-23 12:54:08
